   ...
   <!-- BEGIN: error_warning -->
    ...
    <div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="" method="post"  enctype="multipart/form-data" id="form-money" class="form-horizontal">
				<input type="hidden" name ="money_id" value="{DATA.money_id}" />
				<input name="save" type="hidden" value="1" />
 
				<div class="form-group required">
					<label class="col-sm-4 control-label" for="inputs-title">{LANG.money_title}</label>
					<div class="col-sm-20">
						<input type="text" name="title" value="{DATA.title}" placeholder="{LANG.money_title}" id="inputs-title" class="form-control" />
