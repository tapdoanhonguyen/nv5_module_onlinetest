...
<div class="BoxGroupExam">
	...
	<div class="GroupExam">
		...
		<ul class="list-inline">
			<li><h2><a href="{GROUP_EXAM.link_essay}" title="{GROUP_EXAM.title}">{GROUP_EXAM.title}</a></h2></li>
			<!-- BEGIN: subgrouploop -->
			<li class="hidden-xs"><h4><a title="{SUBGROUP.title}" href="{SUBGROUP.link_essay}">{SUBGROUP.title}</a></h4></li>
			<!-- END: subgrouploop -->
			<!-- BEGIN: subcatmore -->
			<a class="dimgray pull-right hidden-xs" title="{MORE.title}" href="{MORE.link_essay}"><em class="fa fa-sign-out">&nbsp;</em></a>
			<!-- END: subcatmore -->
		</ul>
		<div class="row">
			<!-- BEGIN: loop -->
