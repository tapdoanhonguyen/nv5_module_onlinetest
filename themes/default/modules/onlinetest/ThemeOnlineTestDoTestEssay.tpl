	...
	<div  class="OnlineTestDoTestbox">
		...
		<div id="openTest">
			...
			<div class="sureOpen">
				...
				<div class="box2">
					<button id="sureOpenEssay" type="button" class="btn btn-primary"><i class="fa fa-spinner fa-lg fa-spin" style="display:none"></i> MỞ BÀI THI</button>
					<input type="hidden" id="sureOpenTypeExamId" name="essay_exam_id" value="{DATA.essay_exam_id}"/>
