...
$('#group_user_id').autofill({
	'source': function(request, response) {	 
		$.ajax({
			url: nv_base_siteurl + 'index.php?' + nv_name_variable + '='+ nv_module_name  +'&' + nv_fc_variable + '=group-user&action=get_group&title='+ encodeURIComponent(request) +'&second=' + new Date().getTime(),		
			dataType: 'json',
...
$('#userlists').autofill({
	'source': function(request, response) {	 
		$.ajax({
			url: nv_base_siteurl + 'index.php?' + nv_name_variable + '='+ nv_module_name  +'&' + nv_fc_variable + '=group-user&action=get_user&username='+ encodeURIComponent(request) +'&second=' + new Date().getTime(),		
