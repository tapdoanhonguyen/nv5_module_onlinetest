			...
			<form action="" method="post"  enctype="multipart/form-data" id="form-type_exam" class="form-horizontal">
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						<tbody>
							<tr class="required">
								<td style="width:180px"><div class="title">{LANG.type_exam_title}</div></td>
								<td>
							...
							<tr class="required">
								<td style="width:180px"><div class="title">{LANG.type_exam_group_exam}</div></td>
								<td>
							...
							<tr class="norequired">
								<td style="width:180px"><div class="title">{LANG.type_exam_group_user}</div></td>
								<td>
							...
							<tr class="norequired">
								<td style="width:180px"><div class="title">{LANG.type_exam_point}</div></td>
								<td>
							...
							<tr class="norequired">
								<td style="width:180px"><div class="title">{LANG.type_exam_images}</div></td>
								<td>
									<div class="input-group">
										<input type="text" name="images" id="images" value="{DATA.images}" class="form-control"> 
										<label class="input-group-btn">
											<span class="btn btn-info">
												{LANG.type_exam_select_images}<input id="selectimage" type="button" style="display: none;">
											</span>
										</label>
									</div>
								</td>
							...
							<tr class="norequired">
								<td style="width:180px"><div class="title">{LANG.type_exam_introtext}</div></td>
								<td>
									<textarea name="introtext" class="form-control">{DATA.introtext}</textarea>
								</td>
							</tr>							
							<tr class="norequired">
								<td style="width:180px"><div class="title">{LANG.type_exam_keywords}</div></td>
								<td>
							...
							<tr class="norequired">
								<td style="width:180px"><div class="title">{LANG.type_exam_status}</div></td>
								<td>
							...
							<tr class="required">
								<td style="width:180px"><div class="title">{LANG.type_exam_time}</div></td>
								<td>
							...
							<tr class="required">
								<td style="width:180px"><div class="title">{LANG.type_exam_num_question}</div></td>
								<td>
							...
							<tr class="norequired">
								<td style="width:180px"><div class="title">{LANG.type_exam_type_id}</div></td>
								<td>
							...
							<tr id="showpdf2" class="norequired hidetype">
								<td style="width:180px"><div class="title">{LANG.type_exam_pdf}</div></td>
								<td>
									<div class="input-group">
										<input type="text" name="pdf" id="pdf" value="{DATA.pdf}" data-url="{DATA.pdf}" class="form-control"> 
										<label class="input-group-btn">
											<span class="btn btn-info">
												{LANG.type_exam_pdf_select}<input id="selectpdf" type="button" style="display: none;">
											</span>
										</label>
									</div>
								</td>
							...
							<tr id="showanalyzed2" class="norequired hidetype">
								<td style="width:180px"><div class="title">{LANG.type_exam_analyzed}</div></td>
								<td>
									<div class="input-group">
										<input type="text" name="analyzed" id="analyzed" value="{DATA.analyzed}" data-url="{DATA.analyzed}" class="form-control"> 
										<label class="input-group-btn">
											<span class="btn btn-info">
												{LANG.type_exam_analyzed_select}<input id="selectanalyzed" type="button" style="display: none;">
											</span>
										</label>
									</div>
								</td>
							...
							<tr id="showvideo2" class="norequired hidetype">
								<td style="width:180px"><div class="title">{LANG.type_exam_video}</div></td>
								<td>
									<div class="input-group">
										<input type="text" name="video" id="video" value="{DATA.video}" data-url="{DATA.video}" class="form-control"> 
										<label class="input-group-btn">
											<span class="btn btn-info">
												{LANG.type_exam_video_select}<input id="selectvideo" type="button" style="display: none;">
											</span>
										</label>
									</div>
								</td>
							...
							<tr class="norequired">
								<td style="width:180px"><div class="title">{LANG.type_exam_allow_download}</div></td>
								<td>
				...
				<div id="type1" class="hidetype" style="display:none">
					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover">
							<tbody>
								<tr class="norequired">
									<td style="width:180px"><div class="title">{LANG.type_exam_random}</div></td>
									<td>
						...
						<div class="boxsgroup2 scrollbar" >
							...
							<ul class="list-group">
								...
								<li class="list-group-item" id="item{QUESTION_ID}">
									...
									<div class="qs labelx">
										<!-- BEGIN: answers -->
										<label class="{ANS.class_checked}"><span class="title">{ANS.title}</span><input {ANS.checked} data-ans="{ANS.title}" type="checkbox" class="hide checkbox" name="trueanswer[{QUESTION_ID}][]" value="{ANS.key}" data-id="{QUESTION_ID}"><input type="hidden" value="{ANS.key}" name="answers_list[{QUESTION_ID}][]"></label>
										<!-- END: answers -->
									</div>
...
$('#num_question').on('input propertychange', function(){
	...
	for( i=1; i <= num_question; ++i )
	{
		...
		tmp+='		<label><span class="title">A</span><input data-ans="A" type="checkbox" class="hide checkbox" name="trueanswer['+ i +'][]" value="1" data-id="'+ i +'" ><input type="hidden" value="1" name="answers_list['+ i +'][]"></label>';
		tmp+='		<label><span class="title">B</span><input data-ans="B" type="checkbox" class="hide checkbox" name="trueanswer['+ i +'][]" value="2" data-id="'+ i +'" ><input type="hidden" value="2" name="answers_list['+ i +'][]"></label>';
		tmp+='		<label><span class="title">C</span><input data-ans="C" type="checkbox" class="hide checkbox" name="trueanswer['+ i +'][]" value="3" data-id="'+ i +'" ><input type="hidden" value="3" name="answers_list['+ i +'][]"></label>';
		tmp+='		<label><span class="title">D</span><input data-ans="D" type="checkbox" class="hide checkbox" name="trueanswer['+ i +'][]" value="4" data-id="'+ i +'" ><input type="hidden" value="4" name="answers_list['+ i +'][]"></label>';		
		tmp+='	</div>';
...
$('#input-type').on('change', function(e){
	...
	if( type == 2 )
	{
		...
		for( i=1; i <= num_question; i++ )
		{
			...
			tmp+='	<div class="qs labelx">';
			tmp+='		<label><span class="title">A</span><input data-ans="A" type="checkbox" class="hide checkbox" name="trueanswer['+ i +'][]" value="1" data-id="'+ i +'" ><input type="hidden" value="1" name="answers_list['+ i +'][]"></label>';
			tmp+='		<label><span class="title">B</span><input data-ans="B" type="checkbox" class="hide checkbox" name="trueanswer['+ i +'][]" value="1" data-id="'+ i +'" ><input type="hidden" value="2" name="answers_list['+ i +'][]"></label>';
			tmp+='		<label><span class="title">C</span><input data-ans="C" type="checkbox" class="hide checkbox" name="trueanswer['+ i +'][]" value="1" data-id="'+ i +'" ><input type="hidden" value="3" name="answers_list['+ i +'][]"></label>';
			tmp+='		<label><span class="title">D</span><input data-ans="D" type="checkbox" class="hide checkbox" name="trueanswer['+ i +'][]" value="1" data-id="'+ i +'" ><input type="hidden" value="4" name="answers_list['+ i +'][]"></label>';		
			tmp+='	</div>';
			tmp+='	<div id="trueanswer'+ i +'" class="hide"></div>';
			tmp+='</li>';	
		}
...
$(document).delegate('#search', 'click', function(){
   $.ajax({
		url: script_name + '?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=type_exam&action=getQuestion&nocache=' + new Date().getTime(),
...
function showContent ( page, id )
{
	...
	$.ajax({
		type: "POST",
		dataType: 'json',
		url: script_name + '?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=type_exam&action=getQuestion&page='+ page + '&nocache=' + new Date().getTime(),
		data: $('#searchbox input[type=\'text\'],#searchbox input[type=\'hidden\'], #searchbox input[type=\'checkbox\']:checked'),
		beforeSend: function() {
...
function imageRefresh( )
{
	...
	{
		$('#pdfview').attr('src', script_name + '?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=type_exam&action=pdfview&url=' + $('#pdf').val() );
		$('#pdf').attr('data-url', $('#pdf').val());
		clearInterval(window.clear); 
	}	
}

$("#selectpdf").click(function() {
	var area = "pdf";
	...
	window.clear = setInterval(imageRefresh, 1000);
...
$("#pdf").on('input propertychange', function() {
	if( $('#pdf').val() != '' )
	{
		...
		{
			$('#pdfview').attr('src', script_name + '?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=type_exam&action=pdfview&url=' + urlpdf );
...
$('#grouplist').autofill({
	'source': function(request, response) {	 
		$.ajax({
			url: script_name + '?' + nv_name_variable + '='+ nv_module_name  +'&' + nv_fc_variable + '=type_exam&action=group_user&title='+ encodeURIComponent(request) +'&nocache=' + new Date().getTime(),		
			dataType: 'json',
			success: function(json) {
