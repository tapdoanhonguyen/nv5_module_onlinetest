       ...
       <div class="form-group">
        ...
        <div class="form-group rel">
            <div class="input-group">
                <input type="text" class="required form-control" placeholder="{LANG.question2}" value="" name="your_question" maxlength="255" data-pattern="/^(.){3,}$/" onkeypress="validErrorHidden(this);" data-mess="{LANG.your_question_empty}">
