    ...
    <div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="" method="post"  enctype="multipart/form-data" id="form-question" class="form-horizontal">
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						<tbody>
							...
							<tr>
								<td style="width:130px">{LANG.question_status}</td>
								<td>
							...
							<tr>
								<td colspan="2">
									<a class="btn btn-primary btn-xs" onclick="addAnalyzes($(this))" href="javascript:void(0);" >{DATA.addAnalyzesLang}</a>
							...
							<tr class="insertAnswers" id="boxanwser_{ANSWERS.key}"> 
								<td colspan="2">
									...
									<div style="float:left;margin-top: 10px;">
										...
										<label><input type="checkbox" name="trueanswer_{ANSWERS.key}" id="trueanswer_{ANSWERS.key}" value="1" class="answers" {ANSWERS.trueanswer}> {LANG.true_answers}</label>
				...
				<div align="center">
					<input id="button-send" name="send" class="btn btn-primary" type="submit" value="{LANG.question_send}">
					<input id="button-submit" name="" class="btn btn-primary" type="submit" value="{LANG.save}">
...
function addAnswers() {
	...
	html += '			<label><input type="checkbox" name="trueanswer_' + answer_row + '" id="trueanswer_' + answer_row + '" value="1" class="answers"> {LANG.true_answers}</label>';
